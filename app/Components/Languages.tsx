...
export default function TechNeuralNetwork() {
  ...
  return (
    <section className="relative min-h-screen bg-transparent flex flex-col items-center justify-center overflow-hidden py-20 px-4">
              ...
              <AnimatePresence mode="wait">
                {hoveredIndex !== null ? (
                  ...
                  >
                    ...
                    <span className="text-[10px] text-blue-400 font-mono tracking-widest mt-2 uppercase">
                      Core
                    </span>
                  </motion.div>
                )}
            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    hoveredIndex === i ? `0 0 20px ${skill.color}44` : "",
                }}
              >
                <div
