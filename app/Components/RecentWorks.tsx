...
const projects = [
  ...
  },
  {
    ...
    description:
      "A scalable B2C platform enabling product browsing, secure purchases, and user account management.",
...
export default function RecentProjects() {
  ...
  return (
    <section
      ref={targetRef}
      className={`relative ${isMobile ? "h-auto py-20" : "h-[300vh]"} bg-transparent`}
    >
      <div
              ...
              <div>
                <div className="flex justify-between items-start mb-8 md:mb-12">
                  ...
                  <div className="flex gap-2 md:gap-3 relative z-50">
                    {" "}
                    {/* Added z-50 to ensure links are clickable */}
