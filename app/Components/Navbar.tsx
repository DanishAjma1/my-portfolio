      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-[#8847fd] rounded-lg blur opacity-0 group-hover:opacity-50 transition duration-1000" />
            <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-[#3c11a0] border border-[#000022]/50 text-white/80 font-black text-sm transition-transform group-hover:scale-105">
              DA
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-white text-xs sm:text-sm font-black tracking-tighter uppercase leading-none">
              Danish Ajmal
            </span>
            <span className="text-[8px] sm:text-[10px] text-[#3c11a0] font-mono font-bold tracking-widest uppercase">
        ...
        <div className="hidden md:flex items-center gap-1 p-1 rounded-full">
          {navLinks.map((link) => (
            <a
              ...
              className="px-5 py-2 text-[10px] lg:text-[11px] font-bold uppercase tracking-widest text-[#8847fd] hover:text-white hover:bg-[#000022]/5 rounded-full transition-all duration-300"
            >
              {link.name}
            </a>
          ))}
        ...
        <div className="flex items-center gap-4 relative z-[110]">
          ...
          <button
            ...
            className="flex md:hidden h-10 w-10 items-center justify-center rounded-xl bg-slate-900 border border-[#000022]/20 text-white shadow-lg active:scale-95 transition-transform"
          >
            ...
            <div className="flex flex-col items-center gap-6 w-full max-w-xs">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="text-2xl font-black uppercase tracking-tighter text-white hover:text-[#000022] transition-colors"
                >
                  {link.name}
                </motion.a>
              ))}
              ...
              <motion.a
                ...
                href={`tel:${phoneNumber}`}
                className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-[#000022] text-white font-black uppercase tracking-widest text-sm shadow-[0_10px_30px_rgba(37,99,235,0.3)]"
              >
                <Phone size={18} />
                Call Me Now
              </motion.a>
